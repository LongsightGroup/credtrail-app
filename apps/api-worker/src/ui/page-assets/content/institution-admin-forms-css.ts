...
.ct-admin__form label.ct-checkbox-row,
.ct-admin__form .ct-checkbox-row {
  display: flex;
  align-items: center;
  gap: var(--ct-space-2);
}
...
.ct-admin__form input:not([type='checkbox']):focus-visible,
.ct-admin__form select:focus-visible,
.ct-admin__builder-clone select:focus-visible,
.ct-admin__form textarea:focus-visible,
.ct-admin__table select:focus-visible {
  outline: none;
  border-color: var(--ct-theme-border-focus);
  box-shadow: var(--ct-focus-ring);
}
.ct-admin__form input::placeholder,
.ct-admin__form textarea::placeholder {
  color: var(--ct-theme-text-muted);
  opacity: 1;
}
