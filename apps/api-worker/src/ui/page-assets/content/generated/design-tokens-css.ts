...
:root {
  ...
  --ct-theme-surface-canvas: #f7fafd;
  --ct-theme-surface-shell: rgba(255, 255, 255, 0.94);
  --ct-theme-surface-soft: #f1f6fb;
  --ct-theme-surface-card: rgba(255, 255, 255, 0.98);
  ...
  --ct-theme-gradient-canvas: linear-gradient(180deg, #f7fafd 0%, #ffffff 72%);
  --ct-theme-accent-glow-1: rgba(212, 164, 67, 0.1);
  --ct-theme-accent-glow-2: rgba(15, 95, 166, 0.08);
  --ct-theme-accent-glow-3: rgba(7, 26, 49, 0.04);
  --ct-theme-shadow-card: 0 10px 24px rgba(7, 27, 51, 0.1);
  --ct-theme-shadow-soft: 0 6px 16px rgba(8, 45, 86, 0.08);
  --ct-theme-shadow-shell: 0 18px 38px rgba(13, 32, 58, 0.1);
