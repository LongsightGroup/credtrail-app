...
.public-badge__technical-url-inline {
  display: inline-flex;
  align-items: center;
  gap: 0.35rem;
  max-width: 100%;
...
.public-badge__technical-url-inline > a {
  min-width: 0;
  overflow-wrap: anywhere;
}

.public-badge__icon-button {
  display: inline-flex;
  flex: 0 0 auto;
  box-sizing: border-box;
  appearance: none;
  ...
  padding: 0;
  border: none;
  border-radius: var(--public-badge-panel-inner-radius, 0.35rem);
  background: transparent;
  color: var(--ct-theme-text-muted);
  cursor: pointer;
  transition:
    background var(--ct-duration-fast, 120ms) var(--ct-ease-standard, ease),
    color var(--ct-duration-fast, 120ms) var(--ct-ease-standard, ease);
}

.public-badge__icon-button:hover {
  background: var(--ct-theme-surface-info);
  color: var(--ct-theme-link);
}

.public-badge__icon-button:focus-visible {
  outline: 2px solid var(--ct-theme-border-focus);
  outline-offset: 1px;
}

.public-badge__icon-button-graphic {
  width: 0.95rem;
  height: 0.95rem;
  stroke-width: 1.35;
}
...
.badge-wall__icon-button:focus-visible {
  outline: 2px solid var(--ct-theme-border-focus);
  outline-offset: 1px;
}

.badge-wall__icon-button-graphic {
  width: 0.95rem;
  height: 0.95rem;
  stroke-width: 1.35;
}
