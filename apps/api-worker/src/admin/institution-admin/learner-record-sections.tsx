import { renderLearnerRecordImportSections } from "./learner-record-import-sections";
...
import { CtFieldHint, CtInput } from "../../ui/forms";
import type {
...
export const renderInstitutionAdminLearnerRecordSections = (
  ...
  const { operationsLearnerRecordsPath, learnerRecordReview } = input;
  ...
  return {
    ...
    ...renderLearnerRecordImportSections(input),
  };
};
