...
import { trustEdCredentialDetailsFromOb3Credential } from "./trusted-credential-ob3-projection";
import type { TrustEdCredentialDetails } from "./trusted-credential-ob3-projection";
...
export type { TrustEdCredentialDetails } from "./trusted-credential-ob3-projection";
...
export const trustEdCredentialDetailsFromCredential = (
  ...
  return trustEdCredentialDetailsFromOb3Credential(credential);
};
