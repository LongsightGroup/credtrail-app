...
const {
  ...
  mockedDeleteNeverActiveBadgeIssuanceRule,
  ...
  mockedFindAutomatedBadgeRuleEvaluationStatus,
  mockedRequestManualAutomatedBadgeRuleEvaluation,
  mockedFindLtiResourceLinkPlacementForRule,
  mockedListLtiResourceLinkPlacementsForRule,
  mockedRetireLtiResourceLinkPlacement,
  ...
  return {
    ...
    mockedDeleteNeverActiveBadgeIssuanceRule: vi.fn(),
    ...
    mockedFindAutomatedBadgeRuleEvaluationStatus: vi.fn(),
    mockedRequestManualAutomatedBadgeRuleEvaluation: vi.fn(),
    mockedFindLtiResourceLinkPlacementForRule: vi.fn(),
    mockedListLtiResourceLinkPlacementsForRule: vi.fn(),
    mockedRetireLtiResourceLinkPlacement: vi.fn(),
    mockedListBadgeIssuanceRuleVersionApprovalSteps: vi.fn(),
    mockedListBadgeIssuanceRuleVersionApprovalEvents: vi.fn(),
    mockedListBadgeIssuanceRuleRegistryPage: vi.fn(),
    mockedListBadgeTemplateRuleUsages: vi.fn(),
...
vi.mock("@credtrail/db", async () => {
  ...
  return {
    ...
    listBadgeIssuanceRuleRegistryPage: mockedListBadgeIssuanceRuleRegistryPage,
    listBadgeIssuanceRuleVersions: vi.fn(),
    listBadgeIssuanceRuleVersionsForRules: vi.fn(),
    listBadgeTemplateRuleUsages: mockedListBadgeTemplateRuleUsages,
    findBadgeIssuanceRuleVersionById: mockedFindBadgeIssuanceRuleVersionById,
    findAutomatedBadgeRuleEvaluationStatus: mockedFindAutomatedBadgeRuleEvaluationStatus,
    requestManualAutomatedBadgeRuleEvaluation: mockedRequestManualAutomatedBadgeRuleEvaluation,
    ...
    listLtiResourceLinkPlacementsForRule: mockedListLtiResourceLinkPlacementsForRule,
    retireLtiResourceLinkPlacement: mockedRetireLtiResourceLinkPlacement,
    ...
    deleteNeverActiveBadgeIssuanceRule: mockedDeleteNeverActiveBadgeIssuanceRule,
