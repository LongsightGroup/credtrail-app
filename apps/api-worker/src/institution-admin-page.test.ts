...
describe("GET /tenants/:tenantId/admin", () => {
  ...
  it("returns 403 page when membership role is below admin", async () => {
    ...
    expect(body).toMatch(/class="[^"]*ct-admin__button[^"]*ct-action--secondary/);
  ...
  it("renders institution admin dashboard for admin membership", async () => {
    ...
    expect(body).toContain("Issuance");
    expect(body).toContain("Learner Records");
    expect(body).toContain("Badge Program");
    expect(body).toContain("Reporting");
    expect(body).toContain("People &amp; Access");
    expect(body).toContain("View, import, and export learner records.");
    expect(body).not.toContain("Issue &amp; Inspect");
    ...
    expect(body).toContain('aria-label="Open Issuance workspace"');
    expect(body).toContain('aria-label="Open Learner Records workspace"');
    expect(body).toContain('aria-label="Open Badge Program workspace"');
    expect(body).toContain('aria-label="Open Reporting workspace"');
    expect(body).toContain('aria-label="Open People &amp; Access workspace"');
